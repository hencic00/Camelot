...
function validiraj(premik, deska, prevMove,prevFig,player,details,castleMoves) 
{
				...
				if(znak == "A" || znak == "a" || znak == "B" || znak == "b")
				{
					...
					if(figura.castle == player)  
					{
						...
						for (var i = 20; i < deska.val.length - 20; ++i)
						{
							...
							{
								napadamo.concat(dobiNapadanje(new Figura(Math.floor(i / 14), i % 14, deska), deska));
							}
						}
